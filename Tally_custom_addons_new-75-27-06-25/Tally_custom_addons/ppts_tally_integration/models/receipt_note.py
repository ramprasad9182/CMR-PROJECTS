...
#
#     def action_receipt_note(self):
#         """This method constructs an XML request to synchronize Purchase Receipt
...
#                 scheduled = str(self.scheduled_date.year) + month + day
#
#             if self.purchase_id.date_approve:
#                 day = '0' + str(self.purchase_id.date_approve.day) \
#                     if self.purchase_id.date_approve.day < 10 else str(
#                     self.purchase_id.date_approve.day)
#                 month = '0' + str(self.purchase_id.date_approve.month) \
#                     if self.purchase_id.date_approve.month < 10 else str(
#                     self.purchase_id.date_approve.month)
#                 date_approve = str(self.purchase_id.date_approve.year) + month + day
#
...
#                 scheduled, str(self.id), str(sync_date),self.note,self.partner_id.name,
#                 self.partner_id.name, self.id, self.purchase_id.id, self.partner_id.name)
#             order_line = []
...
#                 rec.picking_id.purchase_id.id,rec.picking_id.purchase_id.id,rec.quantity_done,
#                 rec.quantity_done,date_approve)
