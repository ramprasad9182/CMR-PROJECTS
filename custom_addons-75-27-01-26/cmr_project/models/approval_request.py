...
class ApprovalRequest(models.Model):
    ...
    nhcl_approval_type = fields.Selection([('civil','Civil'),('interior','Interior')],string="Type")
    ...
    def _compute_tax_totals(self):
        ...
        for request in self:
            ...
            if request.currency_id != request.company_currency_id:
                request.tax_totals[
                    'amount_total_cc'] = f"({formatLang(self.env, request.amount_total_cc, currency_obj=self.company_currency_id)})"
    ...
    def action_create_purchase_orders(self):
        ...
        for line in self.product_line_ids:
            ...
            if existing_po:
                ...
                po_vals['nhcl_type'] = self.nhcl_approval_type
