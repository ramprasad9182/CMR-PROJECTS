    ...
    def _check_unique_account_name(self):
        for rec in self:
            if rec.name:
                ...
                domain = [('name', '=', trimmed_name), ('id', '!=', rec.id) ,('company_ids', 'in', company_ids),]
    ...
    def _check_unique_name(self):
        for rec in self:
            if rec.name:
                ...
                domain = [('name', '=', trimmed_name), ('id', '!=', rec.id)]
...
class AccountPayment(models.Model):
    ...
    def _prepare_move_line_default_vals(self, write_off_line_vals=None, force_balance=None):
        ...
        if "BILL/" in payment_ref or "INV/" in payment_ref:
        ...
        # if not vendor_bill and payment_ref:
        #     vendor_bill = self.env['account.move'].search([
        #         ('ref', '=', payment_ref),
        #         ('move_type', '=', 'in_invoice')
        #     ])
